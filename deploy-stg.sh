...
APP_PATH=/usr/local/ls-apps/ls-mesh-server/public/ls-school-widescreen-stg

echo 'Begin deploying to server'

echo 'Clear old files ...'
ssh root@${SERVER_ADDR} 'cd /usr/local/ls-apps/ls-mesh-server/public/ls-school-widescreen-stg && ls -l && rm -rf ./*'
