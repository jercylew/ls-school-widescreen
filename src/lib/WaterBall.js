...
const mergeOption = (userOptions, options) => {
    Object.keys(userOptions).forEach(function (key) {
        options[key] = userOptions[key];
    })
};

const WaterPolo = (selector, userOptions) => {
    // 'user strict';
    ...
    //生成液面
    const makeLiquaid = (ctx, xOffset, waveWidth, waveHeight, color) => {
        ctx.save();
